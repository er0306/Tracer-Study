...
route.post('/kuisioner_instansi_hasil/create', //route
// [mid.isLogin, mid.isLogout, upload.array()], //middleware
hasilkuisionerController.createInstansiItem); //controller
...
route.get('/kuisioner_instansi_hasil/get/:id', //route
// [mid.isLogin, mid.isLogout], //middleware
hasilkuisionerController.getHasilKuisInstansiById); //controller
