    ...
    createItem : async (req,res) => {
        try {
            ...
            let tracerinstansiCreateObj = {
                ...
                nama_orang_instansi: req.body.nama_orang_instansi,
                jabatan_instansi: req.body.jabatan_instansi,
                lingkup: req.body.lingkup,
                tahun: req.body.tahun,
                email: req.body.email,
                alamat: req.body.alamat,
                url_tracer: req.body.url_tracer == null || req.body.url_tracer == "" ? `${url}` : req.body.url_tracer
